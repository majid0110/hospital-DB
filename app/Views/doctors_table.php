              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <td><?= $doctor['Email']; ?></td>
                    <td><?= $doctor['specialization_N']; ?></td>
                    <td>
                        <!-- Action buttons: Edit and Delete -->
                           <a href="<?= base_url("DoctorController/editDoctor/{$doctor['DoctorID']}") ?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="<?= base_url('DoctorController/deleteDoctor/' . $doctor['DoctorID']) ?>" class="btn btn-danger btn-sm">Delete</a>                    </td>
                </tr>
            <?php endforeach; ?>
